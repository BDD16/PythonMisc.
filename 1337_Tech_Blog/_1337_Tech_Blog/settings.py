...
INSTALLED_APPS = [
    ...
    '_1337_Tech_Blog.organizer', #CUSTOMIZE
    '_1337_Tech_Blog.Blog', #CUSTOMIZE
    '_1337_Tech_Blog.superhero', #CUSTOMIZE
    '_1337_Tech_Blog.NeutrinoKey', #CUSTOMIZE
    '_1337_Tech_Blog.core', #CUSTOMIZE
]
