...
import sys
import os
PATH_TO_PYTHON = ''#TODO: make more userfriendly to autodetect where the python package is located
#get ghidra root directory
ghidra_default_dir = os.getcwd()

#get ghidra jython directory
jython_dir = os.path.join(ghidra_default_dir, "Library","Ghidra", "Features", "Python", "lib", "Lib", "site-packages")
...
graph_output_file = os.path.join(ghidra_default_path, "sink_and_caller.gv.pdf")
print(graph_output_file)
#create the graph and view it using graphiz
graph.render(graph_output_file,view=False)
